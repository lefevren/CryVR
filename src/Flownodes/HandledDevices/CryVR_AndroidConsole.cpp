...
////////////////////////////////////////////////////
class CryVR_AndroidConsole : public CFlowBaseNode<eNCT_Instanced>
{
	enum EInputPorts
	{
		EIP_Enable,
...
public:
	////////////////////////////////////////////////////
	CryVR_AndroidConsole(SActivationInfo *pActInfo)
	{
	...
	////////////////////////////////////////////////////
	virtual ~CryVR_AndroidConsole(void)
	{
	...
	////////////////////////////////////////////////////
	virtual IFlowNodePtr Clone(SActivationInfo *pActInfo){return new CryVR_AndroidConsole(pActInfo);}
...
REGISTER_FLOW_NODE("CryVR:HandledDevices:ConsoleListener", CryVR_AndroidConsole);
