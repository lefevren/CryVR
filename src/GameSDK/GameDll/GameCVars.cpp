...
void SCVars::InitCVars(IConsole *pConsole)
{
	...
	REGISTER_CVAR(CryVR_filters_enable, 1, 0, "Use Online Lobby Service (rather than LAN)");
	REGISTER_CVAR(CryVR_filters_euro_enable, 1, 0, "Use Online Lobby Service (rather than LAN)");
	
	REGISTER_CVAR(CryVR_filters_euro_frequence, 120, 0, "Use Online Lobby Service (rather than LAN)");
	REGISTER_CVAR(CryVR_filters_euro_beta, 0.007, 0, "Use Online Lobby Service (rather than LAN)");
	REGISTER_CVAR(CryVR_filters_euro_mincutoff, 1.0, 0, "Use Online Lobby Service (rather than LAN)");
	
	CryVR_vrpn_server_0 = REGISTER_STRING("CryVR_vrpn_server_0","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_1 = REGISTER_STRING("CryVR_vrpn_server_1","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_2 = REGISTER_STRING("CryVR_vrpn_server_2","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_3 = REGISTER_STRING("CryVR_vrpn_server_3","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_4 = REGISTER_STRING("CryVR_vrpn_server_4","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_5 = REGISTER_STRING("CryVR_vrpn_server_5","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_6 = REGISTER_STRING("CryVR_vrpn_server_6","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_7 = REGISTER_STRING("CryVR_vrpn_server_7","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_8 = REGISTER_STRING("CryVR_vrpn_server_8","localhost",VF_NULL, "VRPN server IP");
	CryVR_vrpn_server_9 = REGISTER_STRING("CryVR_vrpn_server_9","localhost",VF_NULL, "VRPN server IP");

	CryVR_vrpn_tracker_0 = REGISTER_STRING("CryVR_vrpn_tracker_0","tracker0",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_1 = REGISTER_STRING("CryVR_vrpn_tracker_1","tracker1",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_2 = REGISTER_STRING("CryVR_vrpn_tracker_2","tracker2",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_3 = REGISTER_STRING("CryVR_vrpn_tracker_3","tracker3",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_4 = REGISTER_STRING("CryVR_vrpn_tracker_4","tracker4",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_5 = REGISTER_STRING("CryVR_vrpn_tracker_5","tracker5",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_6 = REGISTER_STRING("CryVR_vrpn_tracker_6","tracker6",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_7 = REGISTER_STRING("CryVR_vrpn_tracker_7","tracker7",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_8 = REGISTER_STRING("CryVR_vrpn_tracker_8","tracker8",VF_NULL, "VRPN TRACKER NAME");
	CryVR_vrpn_tracker_9 = REGISTER_STRING("CryVR_vrpn_tracker_9","tracker9",VF_NULL, "VRPN TRACKER NAME");

	
	REGISTER_CVAR(CryVR_udp_sender_port_0, 8051, 0, "UDP SENDER PORT");
	REGISTER_CVAR(CryVR_udp_sender_port_1, 8051, 0, "UDP SENDER PORT");
	REGISTER_CVAR(CryVR_udp_sender_port_2, 8051, 0, "UDP SENDER PORT");


	CryVR_udp_sender_ip_0 = REGISTER_STRING("CryVR_udp_sender_ip_0","udp_sender_ip_0",VF_NULL, "UDP SENDER IP");
	CryVR_udp_sender_ip_1 = REGISTER_STRING("CryVR_udp_sender_ip_1","udp_sender_ip_1",VF_NULL, "UDP SENDER IP");
	CryVR_udp_sender_ip_2 = REGISTER_STRING("CryVR_udp_sender_ip_2","udp_sender_ip_2",VF_NULL, "UDP SENDER IP");
		
	REGISTER_CVAR(CryVR_udp_listener_console_port_0, 8051, 0, "UDP SENDER PORT");
	REGISTER_CVAR(CryVR_udp_listener_console_port_1, 8051, 0, "UDP SENDER PORT");
	REGISTER_CVAR(CryVR_udp_listener_console_port_2, 8051, 0, "UDP SENDER PORT");
	
	REGISTER_CVAR(CryVR_udp_listener_event_port_0, 8051, 0, "UDP SENDER PORT");
	REGISTER_CVAR(CryVR_udp_listener_event_port_1, 8051, 0, "UDP SENDER PORT");
	REGISTER_CVAR(CryVR_udp_listener_event_port_2, 8051, 0, "UDP SENDER PORT");
...
void CGame::CmdTakeDamage(IConsoleCmdArgs *pArgs)
{
	...
	{
		HitInfo suicideInfo(pClientActor->GetEntityId(), pClientActor->GetEntityId(), pClientActor->GetEntityId(),
			49, 0, 0, -1, CGameRules::EHitType::Bullet, ZERO, ZERO, ZERO);
