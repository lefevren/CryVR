...
{	
  ...
  int g_testStatus;
	...
	float CryVR_filters_enable;
	float CryVR_filters_euro_enable;
	float CryVR_filters_euro_frequence;
	float CryVR_filters_euro_beta;
	float CryVR_filters_euro_mincutoff;
	
	ICVar * CryVR_vrpn_server_0;
	ICVar * CryVR_vrpn_server_1;
	ICVar * CryVR_vrpn_server_2;
	ICVar * CryVR_vrpn_server_3;
	ICVar * CryVR_vrpn_server_4;
	ICVar * CryVR_vrpn_server_5;
	ICVar * CryVR_vrpn_server_6;
	ICVar * CryVR_vrpn_server_7;
	ICVar * CryVR_vrpn_server_8;
	ICVar * CryVR_vrpn_server_9;

	ICVar * CryVR_vrpn_tracker_0;
	ICVar * CryVR_vrpn_tracker_1;
	ICVar * CryVR_vrpn_tracker_2;
	ICVar * CryVR_vrpn_tracker_3;
	ICVar * CryVR_vrpn_tracker_4;
	ICVar * CryVR_vrpn_tracker_5;
	ICVar * CryVR_vrpn_tracker_6;
	ICVar * CryVR_vrpn_tracker_7;
	ICVar * CryVR_vrpn_tracker_8;
	ICVar * CryVR_vrpn_tracker_9;

	int CryVR_udp_sender_port_0;
	int CryVR_udp_sender_port_1;
	int CryVR_udp_sender_port_2;

	ICVar * CryVR_udp_sender_ip_0;
	ICVar * CryVR_udp_sender_ip_1;
	ICVar * CryVR_udp_sender_ip_2;

	int CryVR_udp_listener_console_port_0;
	int CryVR_udp_listener_console_port_1;
	int CryVR_udp_listener_console_port_2;

	int CryVR_udp_listener_event_port_0;
	int CryVR_udp_listener_event_port_1;
	int CryVR_udp_listener_event_port_2;
